"""
3_estimate_bootstrap_stability.py
=============================================================
Computes cumulative confidence intervals across bootstrap
iterations to evaluate the convergence and stability of the 
statistical tests.

Input per disease
-----------------
<disease>_distributions.csv:
    The output distributions generated by 3_compute_stats.py, 
    containing bootstrap iteration results and metrics per method.

Outputs
-----------------------------------------------
bootstrap_stability_table.csv (or specified --out_csv):
    A single aggregated table containing the cumulative CIs 
    and delta changes across iterations for all specified diseases.
